...
10. Antes do primeiro comando local/remoto de cada chat/agente, aplicar `rules/session-bootstrap.md`, executar `scripts/session_bootstrap.py` e exigir `BOOTSTRAP_OK`.
