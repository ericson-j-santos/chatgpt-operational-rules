...
19. Automação remota por GUI não pode digitar comandos como fallback; aplicar a seção de automação remota de interface de `rules/terminal-execution.md`, com bloqueio fail-closed e validação semântica.
